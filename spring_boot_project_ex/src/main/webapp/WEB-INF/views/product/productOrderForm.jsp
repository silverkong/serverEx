			...
			<form method="post" action="<c:url value='/product/orderComplete'/>">
				...
				<table border="1">
					...
					<tr>
						<th>배송지 주소</th>
						<td colspan="3">
							<input type="text" id="zipcode" name="ordZipcode" value="${memInfo.memZipcode}" size="7" readonly>
		            		<input type="button" id="searchZipBtn" name="searchZipBtn" value="우편번호 찾기"><br>
		            		<input type="text" id="address1" name="ordRcvAddress1" value="${memInfo.memAddress1}" placeholder="주소 입력" readonly size="80"><br>
		            		<input type="text" id="address2" name="ordRcvAddress2" value="${memInfo.memAddress2}" placeholder="상세 주소 입력" size="80">
	            		</td>
					</tr>
					<tr>
						<th>배송메세지</th>
				...
				<br>			
				<input type="submit" value="결제완료"/><br><br>
			</form>
